...
<div class="h-screen flex flex-row flex-wrap">
  ...
  <div class="bg-gray-100 flex-1 p-6 md:mt-16">
    ...
    <div class="container mt-4">
        <form method="post" action="{{route('post-beneficiary')}}">
          @csrf
          <div class="row">
            <div class="col-25">
          ...
          <div class="row">
            ...
            <div class="col-75">
              <input required type="number" id="age" name="age" placeholder="age" min="0">
            </div>
          </div>
          <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
              <input required type="tel" id="contact" name="contact" placeholder="+25474***1815">
            </div>
          </div>
          <div class="row">
            <div class="col-25">
            ...
            <div class="col-75">
              <textarea name="medical_history" id="history" cols="30" rows="10"></textarea>
            </div>
          </div>
          <div class="row">
